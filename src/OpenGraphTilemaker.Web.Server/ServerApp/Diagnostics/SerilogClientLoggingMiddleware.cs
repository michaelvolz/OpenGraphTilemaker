...
namespace OpenGraphTilemaker.Web.Server.ServerApp.Diagnostics
{
    internal class SerilogClientLoggingMiddleware
    {
        ...
        private readonly LoggingLevelSwitch _clientLevelSwitch;
        ...
        public async Task Invoke(HttpContext context, Func<Task> next) {
            ...
            if (_clientLevelSwitch != null) await context.Response.WriteAsync("{\"MinimumLevelAccepted\":\"" + _clientLevelSwitch.MinimumLevel + "\"}");
        }
    }
}
