...
namespace OpenGraphTilemaker.Web.Client.ClientApp.Diagnostics
{
    ...
    {
        private const string DefaultOriginEndpointUrl = "serilog";
        ...
        /// </param>
        /// <param name="bufferSizeLimitBytes">
        ...
        ///     dynamically controlled. Do not specify <paramref name="restrictedToMinimumLevel" /> with this setting.
        /// </param>
